 ...
 * @updateDes ${TODO}
 */
public class MyRecycleViewAdapter_SubjectThree extends RecyclerView.Adapter {
    private final Context context;
    private int currentItem = 0;


    public MyRecycleViewAdapter_SubjectThree(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            ...
            View Driving_skills = View.inflate(context, R.layout.driving_skills_subjectthree, null);
    ...
    private class Driving_Videos_ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData() {
            gv.setAdapter(new MyGridViewVideosAdapter_SubjectThree(context));
    ...
    private class Driving_Skills_ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData() {
            gv.setAdapter(new MyGridViewAdapter_SubjectThree(context));
        }
    }
}
