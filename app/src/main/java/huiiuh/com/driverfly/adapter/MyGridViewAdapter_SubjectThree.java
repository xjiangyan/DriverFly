 ...
 * @updateDes ${TODO}
 */
public class MyGridViewAdapter_SubjectThree extends BaseAdapter {
    ...
    private String[] texts = new String[]{"车距判断", "档位操作", "灯光", "直行", "经验技巧"};
    ...
    public MyGridViewAdapter_SubjectThree(Context context) {
