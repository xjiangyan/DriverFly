...
import huiiuh.com.driverfly.adapter.MyRecycleViewAdapter_SubjectThree;
 ...
 * @updateDes ${TODO}
 */
public class Subject_Three extends BaseFragment {
    ...
    private void initReccleView() {
        ...
        MyRecycleViewAdapter_SubjectThree myRecycleViewAdapter_subjectThree = new MyRecycleViewAdapter_SubjectThree(mContext);
        mRvSubjecttwo.setAdapter(myRecycleViewAdapter_subjectThree);
